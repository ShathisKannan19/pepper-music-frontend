					...
					<CardContent className="p-0">
						...
						<div className="bg-white text-black p-6 rounded-t-lg border-b border-gray-800">
							<p className="text-lg">
								...
								By using the Bot, you agree to comply with these Terms. If you
						...
						<ScrollArea className="p-6 h-[600px] bg-black">
							...
							<div className="mb-8">
								...
								<div className="pl-11 space-y-3 text-gray-300">
									<p>
										...
										You may use the Bot on Discord servers that you own or have
										appropriate permissions to use it on.
									</p>
									<p>
										...
										to copyright infringement or spreading harmful or offensive
										content.
									</p>
									<p>
										The Bot may periodically undergo maintenance or updates,
										which may result in temporary unavailability. We strive to
										minimize disruptions and will provide notice when feasible.
									</p>
								</div>
							</div>
							...
							<div className="mb-8">
								...
								<div className="pl-11 space-y-3 text-gray-300">
									<p>
										You are solely responsible for your actions and content when
										using the Bot. You shall not engage in any behavior that may
										cause harm, harass others, violate their privacy, or disrupt
									...
									<p>
										...
										scan, or test the security vulnerabilities of the Bot or any
										associated networks.
									</p>
								</div>
							</div>
							...
							<div className="mb-8">
								...
								<div className="pl-11 space-y-3 text-gray-300">
									<p>
										...
										in accordance with applicable privacy laws and our Privacy
										Policy. By using the Bot, you consent to the collection,
										use, and disclosure of your personal information as
							...
							<div className="mb-8">
								...
								<div className="pl-11 space-y-3 text-gray-300">
									<p>
										...
										acknowledge that you have no ownership rights to the Bot or
										its intellectual property.
									</p>
									<p>
										You shall not reproduce, modify, distribute, sell, or
										exploit any part of the Bot without prior written permission
										from us.
									</p>
								</div>
							</div>
							...
							<div className="mb-8">
								...
								<div className="pl-11 space-y-3 text-gray-300">
									<p>
										The Bot is provided on an "as-is" basis, without warranties
									...
									<p>
										...
										connection with the use of the Bot, including but not
							...
							<div className="mb-8">
								...
								<div className="pl-11 space-y-3 text-gray-300">
									<p>
										We reserve the right to suspend, terminate, or restrict your
										access to the Bot at any time, without prior notice or
										liability, if you breach these Terms or engage in any misuse
							...
							<div className="mb-8">
								...
								<div className="pl-11 space-y-3 text-gray-300">
									<p>
										We may update or revise these Terms at any time. Any changes
										will be effective immediately upon posting on our website or
										notifying users through other means.
									</p>
									<p>
										It is your responsibility to review the Terms periodically.
										By continuing to use the Bot after the revised Terms have
						...
						<div className="bg-white p-6 rounded-b-lg border-t border-gray-800">
							<p className="text-sm text-black text-center">
								By using Pepper, you acknowledge that you have read, understood,
