						...
						<Card className="bg-black overflow-hidden">
							<CardContent className="p-8">
								<p className="text-lg text-white leading-relaxed">
									...
									<span className="font-bold text-white">Pepper</span> is here
									to bring the power of music to your Discord server. Get ready
									to immerse yourself in a world of melodies, beats, and rhythm
									that will elevate your community interactions.
								</p>
							</CardContent>
						</Card>
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
							<Card className="bg-black h-full">
								<CardContent className="p-8 h-full flex flex-col">
									...
									<p className="text-white flex-grow">
										...
										sources like Spotify, SoundCloud, Apple Music and more. Create
							...
							<Card className="bg-white border-0 h-full">
								<CardContent className="p-8 h-full flex flex-col">
									...
									<p className="text-black flex-grow">
										Pepper is not just about playing music—it's about fostering
										a vibrant and lively community. Connect with your members
										through shared playlists, let them request their favorite
										songs, and create a harmonious environment that resonates
										with everyone.
									</p>
								</CardContent>
							</Card>
							...
							<Card className="bg-white border-0 h-full">
								<CardContent className="p-8 h-full flex flex-col">
									...
									<p className="text-black flex-grow">
										Whether you're hosting a gaming session, throwing a party,
										or simply relaxing with friends, Pepper is your trusty
										companion for an unforgettable musical journey. Summon
										Pepper to your voice channel, and watch as it fills the air
										with your chosen tracks, keeping the vibes alive.
									</p>
								</CardContent>
							</Card>
							...
							<Card className="bg-black h-full">
								<CardContent className="p-8 h-full flex flex-col">
									...
									<p className="text-white flex-grow">
										...
										delivering regular updates, introducing exciting new
										features, and providing top-notch support to meet your music
										needs.
									</p>
								</CardContent>
							</Card>
							...
							<CardContent className="p-8">
								...
								<div className="text-gray-300 space-y-4">
									...
									<p>
										...
										support server, where our friendly community and
										knowledgeable staff are ready to assist you.
									</p>
									<p>
