					...
					<CardContent className="p-0">
						...
						<div className="bg-white text-black p-6 rounded-t-lg border-b border-gray-800">
							<p className="text-lg">
								...
								By using the Bot, you consent to the practices described in this
								Policy.
							</p>
						</div>
						...
						<ScrollArea className="p-6 h-[600px] ">
							...
							<div className="mb-8">
								...
								<div className="pl-11 space-y-3 text-gray-300">
									<p>
										Personal Information: When you interact with the Bot, we may
									...
									<ul className="list-disc pl-6 space-y-2">
										...
										<li>
											...
											played, such as the title, artist, and duration. This data
											helps improve the user experience and is used for
											statistical purposes.
										</li>
										<li>
											<span className="font-semibold">Command Usage Data:</span>{' '}
											The Bot may collect information about the commands used by
											individual users for bug fixing, troubleshooting, and
										...
										<li>
											...
											The Bot may track statistics related to individual users,
											such as the number of tracks played, total listen time,
											and overall command usage count. These statistics help in
											understanding user engagement and enhancing the bot's
											features.
										</li>
										<li>
											<span className="font-semibold">
										...
										<li>
											<span className="font-semibold">Server Data:</span> We may
											collect data related to the server such as ID, server
											name, owner ID and total members when bot is added to a
											guild. The data we collect here is solely used for
											debugging and upgrade purposes.
										</li>
									</ul>
								</div>
							</div>
							...
							<div className="mb-8">
								...
								<div className="pl-11 space-y-3 text-gray-300">
									...
									<ul className="list-disc pl-6 space-y-2">
										...
										<li>
											Analyzing usage patterns to enhance the Bot's features and
											performance.
										</li>
										<li>Troubleshooting and fixing bugs reported by users.</li>
							...
							<div className="mb-8">
								...
								<div className="pl-11 space-y-3 text-gray-300">
									<p>
										...
										alteration. However, please note that no method of
							...
							<div className="mb-8">
								...
								<div className="pl-11 space-y-3 text-gray-300">
									<p>
										The Bot is not intended for individuals under the age of 13.
										We do not knowingly collect or solicit personal information
										from children. If we become aware that we have collected
										personal information from a child without parental consent,
							...
							<div className="mb-8">
								...
								<div className="pl-11 space-y-3 text-gray-300">
									<p>
										...
										information collected by the Bot. To submit a data deletion
